...
class adminReview:
    ...
    def insertData(self, dataSource, review):
        #Generamos la Query
        query = ("INSERT INTO reviews VALUES (%i,%i,%f,%f,%f,%f,%f,%i)" %(review.getReview_id(), review.getIdBeer(), review.getTaste(), review.getPalate(), review.getAroma(), review.getAppearance(), review.getOverall(), review.getUsers_Id()))
    ...
    def updateData(self,dataSource,review):
        #Generamos la Query
        query = ("UPDATE reviews SET beer_idbeer=%i, review_taste=%f, review_palate=%f, review_aroma=%f, review_appearance=%f, review_overall=%f, users_id=%i WHERE review_id=%i" %(review.getIdBeer(), review.getTaste(), review.getPalate(), review.getAroma(), review.getAppearance(), review.getOverall(), review.getUsers_Id(), review.getReview_id()))
